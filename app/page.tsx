...
import { MOCK_SCENARIOS, SCENARIO_LABELS } from "@/lib/mock-data";
...
export default function Home() {
  ...
  const allAlerts = generateAlerts(positions);
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 space-y-8">
        ...
        <p className="text-center text-xs text-slate-700 pb-4">
          Vault state is seeded demo data &middot; Alerts generated by local engine &middot;{" "}
          <a
            href="/api/alerts"
            target="_blank"
