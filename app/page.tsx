...
const BASE_URL = "https://lido-vault-alert-agent.vercel.app";
    ...
    <>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "72px 28px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          <Image src="/logo.png" alt="Lido Vault Bot" width={72} height={72} style={{ borderRadius: 18, imageRendering: "pixelated", marginBottom: 24 }} />
          <h1 style={{
