...
**Live:** https://www.lidovaultagent.app/

## What it does

- **Telegram bot** — users subscribe with their wallet, set alert preferences, and receive personalized vault alerts
- **Less noisy delivery** — critical issues send immediately; lower-priority warnings are bundled into morning and evening digests
