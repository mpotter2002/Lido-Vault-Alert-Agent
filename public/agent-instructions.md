...
You have access to the Lido Vault Alert Agent API at https://www.lidovaultagent.app
...
```
GET https://www.lidovaultagent.app/api/health?wallet=WALLET_ADDRESS
```
...
```
GET https://www.lidovaultagent.app/api/alerts
```
...
```
GET https://www.lidovaultagent.app/api/yield-floor?vault=earnETH&wallet=WALLET_ADDRESS
```
